// Auto-generated at 2026-07-29 00:37:16.540309 by ops-translator
...
//  =======================================================
    ...
    double dx_val = *(double *)args[1].data;
...
//  =============
    ...
    if ((end_indx[0]-start_indx[0])>0 && (end_indx[1]-start_indx[1])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
            ...
            cgh.parallel_for<class KerInitGrid_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
