// Auto-generated at 2026-07-29 00:37:16.373991 by ops-translator
...
//  =================================================
    ...
    if (xdim0 != dims_KerInitGrid_h[0][0]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_KerInitGrid, dims_KerInitGrid_h, sizeof(dims_KerInitGrid)));
    }
