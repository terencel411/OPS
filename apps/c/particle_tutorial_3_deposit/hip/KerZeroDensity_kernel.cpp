// Auto-generated at 2026-07-29 00:37:16.376334 by ops-translator
...
//  =================================================
    ...
    if (xdim0 != dims_KerZeroDensity_h[0][0]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_KerZeroDensity, dims_KerZeroDensity_h, sizeof(dims_KerZeroDensity)));
    }
