// Auto-generated at 2026-07-29 00:37:16.357264 by ops-translator
...
//  =================================================
    ...
    if (xdim0 != dims_KerSumDensity_h[0][0]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_KerSumDensity, dims_KerSumDensity_h, sizeof(dims_KerSumDensity)));
    }
